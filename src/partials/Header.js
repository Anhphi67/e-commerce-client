...
import MenuNav from '../partials/Dropdown';
...
function Header({ isLoggedIn, user, cart, dispatch }) {
      ...
      {({ open }) => (
        <>
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between md:hidden">
              <div >
                ...
                <div
                  ...
                  className={`fixed inset-0 z-20 block transition-opacity bg-black opacity-50 lg:hidden ${isOpen ? "block" : "hidden"
                    }`}
                />
              ...
              <div className="">
                <div className="flex items-center">
                  <div className="p-2 xl:col-span-3 sm:col-span-4">
                    <button
                      className={`relative w-8 h-8 flex items-center justify-center bg-gray-200 hover:bg-gray-200 transition duration-150 rounded-full ml-3 ${isSearch && 'bg-gray-200'}`}
                    ...
                    >
                      ...
                      {isSearch ? (
                            <span className="box-triangle">
                              <svg viewBox="0 0 20 9" role="presentation"><path d="M.47108938 9c.2694725-.26871321.57077721-.56867841.90388257-.89986354C3.12384116 6.36134886 5.74788116 3.76338565 9.2467995.30653888c.4145057-.4095171 1.0844277-.40860098 1.4977971.00205122L19.4935156 9H.47108938z" fill="#ffffff"></path></svg>
                            </span>
                            ) : null}
                          </button>
                          {isSearch ? (
                            <div className="absolute z-50 w-full right-0 ">
                              <div className="quote relative w-full bg-white">
                                <p className="ttbold">Tìm kiếm</p>
                                <div className="bg-white  px-4 pt-2 pb-8 shadow-md" role="alert">
                                <div className="pt-2 relative mx-auto text-gray-600">
                                  <input className="w-full border rounded-none border-gray-300  h-10 px-5 pr-16 focus:outline-none bg-gray-100 text-xs" type="search" name="search" placeholder="Tìm kiếm sản phẩm" />
                  ...
                  <div className="relative p-2 xl:col-span-2 sm:col-span-3">
                    ...
                    >
                      ...
                      <span className=" bg-orange-999 absolute -top-3 -right-5 w-4 h-4  rounded-full flex items-center justify-center"><span className="text-sx text-white">{countCart}</span></span>
            ...
            <div className="hidden h-auto md:grid grid-cols-12 gap-4 relative items-center justify-between">
              ...
              <div className="col-span-6  hidden md:block">
                <div className="justify-around md:block sm:hidden  mx-auto">
                  <MenuNav />
                </div>
              </div>
              <div className="col-span-5  flex justify-end">
                <div className="flex items-center">
                  <div className="mr-1">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-orange-999 " fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M21 3l-6 6m0 0V4m0 5h5M5 3a2 2 0 00-2 2v1c0 8.284 6.716 15 15 15h1a2 2 0 002-2v-3.28a1 1 0 00-.684-.948l-4.493-1.498a1 1 0 00-1.21.502l-1.13 2.257a11.042 11.042 0 01-5.516-5.517l2.257-1.128a1 1 0 00.502-1.21L9.228 3.683A1 1 0 008.279 3H5z" />
                    </svg>
                  </div>
                  <div>
                    <div><span className="text-xs">Liên hệ Zalo</span></div>
                    <div className="text-orange-999"> <span className="font-semibold text-sm ">0965649123</span></div>
                  </div>
                </div>
                <div >
                    ...
                    <div className="">
                      <div className="flex items-center">
                        <div className="p-2 xl:col-span-3 sm:col-span-4">
                          ...
                          {isSearch ? (
                            <div className="absolute z-50 w-96 right-0 ">
                              <div className="quote relative w-full bg-white">
                                <p className="ttbold">Tìm kiếm</p>
                                <div className="bg-white  px-4 pt-2 pb-8 shadow-md" role="alert">
                                <div className="pt-2 relative mx-auto text-gray-600">
                          ...
                          <div className="flex justify-center items-center group">
                            <Menu.Button className="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                              {(isLoggedIn && user.image != null) ? (
                                ...
                                />) : (
                                <img
                                  className="h-8=6 w-8 rounded-full"
                                  src="data:image/jpeg;base64,"
                                  alt=""
                                />
                              )}
                            ...
                            {/* <div className="xl:flex items-center truncate hidden">
                              {isLoggedIn ? (
                                <span className="truncate ml-2 text-sm font-medium group-hover:text-gray-800">{user.firstName || ''}</span>
                              ) : (
                                <span className="truncate ml-2 text-sm font-medium group-hover:text-gray-800">Login</span>

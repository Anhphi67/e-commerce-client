            ...
            <Layout>
                <main className="flex-grow">
                    ...
                    <div className="w-full md:flex mx-auto px-4 sm:px-6 ">
                        <div className="md:w-1/4 h-auto pt-4 mt-2 mb-2 bg-gray-100  shadow-sm" >
                        ...
                        <div className="md:w-3/4 h-auto pt-4 mt-2 mb-2 bg-gray-100 shadow-sm ">
                            <div className="px-4">
                            ...
                            <div className="md:flex">
                                <div className="md:w-1/2 px-4 h-40">
                                    <label>
                                        ĐỊA CHỈ NGƯỜI NHẬN
                                    </label>
                            ...
                            <div className="min-h-1/625 mt-4">
